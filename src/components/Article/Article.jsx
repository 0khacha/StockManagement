...
function Articles() {
    const [newArticle, setNewArticle] = React.useState({
        ...
        description: '',
        image: '',
        localisation: '' // Added localisation property
    });

    const [articles, setArticles] = React.useState([
        { id: 1, article: 'Article 1', category: 'Category 1', quantity: 10, unitPrice: 20, manufacturingDate: '2024-05-04', description: 'Description 1', image: 'image1.jpg', localisation: 'Location 1' },
        { id: 2, article: 'Article 2', category: 'Category 2', quantity: 20, unitPrice: 30, manufacturingDate: '2024-05-05', description: 'Description 2', image: 'image2.jpg', localisation: 'Location 2' },
        { id: 3, article: 'Article 3', category: 'Category 3', quantity: 30, unitPrice: 40, manufacturingDate: '2024-05-06', description: 'Description 3', image: 'image3.jpg', localisation: 'Location 3' },
        { id: 4, article: 'Article 4', category: 'Category 4', quantity: 40, unitPrice: 50, manufacturingDate: '2024-05-07', description: 'Description 4', image: 'image4.jpg', localisation: 'Location 4' },
    ]);
            ...
            <div className='forme'>
                <form action="" className='formulaire' onSubmit={handleSubmit}>
                    <div className='title-input'>
                        <h5>Article</h5>
                        <input type="text" name="article" value={newArticle.article} onChange={handleInputChange}
                    ...
                    <div className='title-input'>
                        <h5>Localisation</h5>
                        <input type="text" name="localisation" value={newArticle.localisation}
                               onChange={handleInputChange}
                               placeholder='Please enter the localisation ...'/>
                    </div>
                    <div className='title-input'>
                        <h5>Image</h5>
